...
class StockShow extends React.Component {
  ...
  getData(symbol) {
    this.props.getSearch().then(() => {
      this.props
        .getStockDisplay(symbol)
        .then(this.props.getStockHistoricalCharts(symbol));
  ...
  render() {
    if (!this.props.info || !this.props.info.close || !this.props.news) {
